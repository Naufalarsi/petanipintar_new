...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> pages = [
      _buildDashboardHome(), // Index 0: Dashboard (Kodingan lamamu)
    ...
    return Scaffold(
      ...
      // 4. MENGGUNAKAN INDEXED STACK AGAR BISA GANTI HALAMAN
      body: IndexedStack(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          // Panggil fungsi menampilkan bottom sheet
  ...
  // =======================================================================
  // INI ADALAH KODINGAN LAMA KAMU YANG DIJADIKAN SATU WIDGET DASHBOARD HOME
  // =======================================================================
  ...
  // WIDGET: CARD INFORMASI LAMA (Hanya teks kosong)
  ...
  // WIDGET: ITEM BOTTOM NAVIGATION (Sekarang bisa diklik menggunakan InkWell)
